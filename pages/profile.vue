<template>
    <div>
        <Header title="HubSpot autocomplete" goBack="true" />
        ...
        <section class="w-96 block m-auto mt-4 pt-2">
            ...
            <p class="text-sm mt-2 mb-2" >Welcome to your Profile Page! Here, you can personalize your experience .</p>
                ...
                <form @submit.prevent="pressed">
                    ...
                    <button class="bg-orange rounded-xl text-white font-medium  text-sm block w-full px-4 py-2" > Update your profile</button>
