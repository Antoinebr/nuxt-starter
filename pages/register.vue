<template>
    <div>
        <Header title="Register" goBack="true" />
        ...
        <section class="w-96 block m-auto">
            ...
            <div class="pt-2 pb-2">
                ...
                <form @submit.prevent="pressed">
                    ...
                    <button class="bg-primary rounded-xl text-white font-medium text-sm block w-full px-4 py-2 hover:bg-black/80"> Register</button>
                    
                </form>

                <p class="text-center mt-2 text-xs"> or </p>

                <button @click="googleSignIn"
                    class="mt-2 block m-auto px-4 py-2 border flex gap-2 border-slate-200 rounded-lg text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
        ...
        methods: {
            ...
            async googleSignIn() {
                ...
                try {
                    ...
                    this.$root.context.redirect({name: 'profile'});
                    console.log('Now registered with Google 🔥')
                } catch (error) {
